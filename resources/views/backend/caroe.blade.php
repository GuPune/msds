...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">ภาพสไลด์</h1>
                ...
                <table class="table table-bordered" id="example" width="100%" cellspacing="0" style="text-align: center;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                    <a class="btn btn-warning btn-edit" href="{{ route('carosel.edit',$rs['id']) }}" data-popup="tooltip" title="แก้ไข" data-placement="bottom">
