...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">จัดการลงทะเบียน</h1>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered" id="example" width="100%" cellspacing="0" style="text-align: center;">
                    ...
                    <tbody>
                        @foreach($system as $key => $rs)
                        <tr>
                            <td class="text-center">{{$key+1}}</td>
                            <td class="text-center">
                                {!! QrCode::size(100)->generate($rs->url); !!}
                            </td>
                            ...
                            <td class="text-center">
                               ...
                               <td class="text-center">
                                <a class="btn btn-warning btn-edit" href="{{ route('regis.edit',$rs['id']) }}" data-popup="tooltip" title="แก้ไข" data-placement="bottom">
