...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">แก้ไขการลงทะเบียน</h1>
    @if ($errors->any())
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
        <form method="POST" action="{{ route('regis.update',$sys->id) }}" >
                    {{ method_field('PUT') }}
                    {{ csrf_field() }}
            <div class="form-group col-12">
                <div class="form-row">
                    <div class="form-group col-md-12">
                      <label for="inputEmail4">โทเคน</label>
                      <input type="text" class="form-control" id="token" name="token" placeholder="Token" value="{{$sys->token}}" required disabled>
                    </div>
                  </div>

                  <div class="form-row">
                    <div class="form-group col-md-12">
                      <label for="inputEmail4">ลิงค์</label>
