...
@endif
    ...
    <h1 class="h3 mb-4 text-gray-800">ผู้เข้าประกวด
      ...
      <div class="card shadow mb-4">
        <form method="GET"  action="{{ url('/admin/setting/votess') }}" >
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <select class="form-control form-control-sm" name="period">
                            <option value="D" @if($period == 'D') selected @endif>เช้า</option>
                            <option value="N" @if($period == 'N') selected @endif>บ่าย</option>
                          </select>
                      </div>
                    </div>
                  </div>
