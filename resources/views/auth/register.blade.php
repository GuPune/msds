              ...
              <form class="pt-3" method="POST" action="{{ route('register.post') }}" onsubmit="return validateForm();">
                ...
                @csrf
                  ...
                  <div class="form-group">
                    ...
                    <input id="fname" type="text" class="form-control form-control-lg" style="border-radius: 10px;" placeholder="First Name"  name="fname"  required oninput="validateAlpha();">
                    @if ($errors->has('fname'))
                ...
                @endif
                  ...
                  <div class="form-group">
                    ...
                    <input id="lname" type="text" style="border-radius: 10px;" class="form-control  @error('password') is-invalid @enderror"  placeholder="Last Name" name="lname" required oninput="validateAlphalname();">
                    @if ($errors->has('lname'))
                ...
                @endif
                  ...
                  <div class="form-group">
                    ...
                    <input id="department" type="text" style="border-radius: 10px;" class="form-control"   placeholder="Department" name="department" required oninput="validateAlphadep();">
                    @if ($errors->has('dep'))
                ...
                @endif
                  ...
                  <div class="form-group">
                    ...
                    <input id="password_confirmation" type="password" name="password_confirmation"  style="border-radius: 10px;" class="form-control  @error('password') is-invalid @enderror"   required placeholder="Confirm Password" required="required" oninput="validateAlphaPassC();">
